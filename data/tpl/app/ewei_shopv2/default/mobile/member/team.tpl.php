        ...
        <div class="fui-list-group address-item" style=''
            ...
            <div  class="fui-list" >
                <div class="fui-list-inner">
                    ...
                    <p style="font-weight: bold; font-size: 0.7rem;">用户电话：<span style="font-weight: normal"> <?php  echo $mem['nickname'];?></span></p>
                    <p style="display: inline-block; font-weight: bold; font-size: 0.7rem;">团队人数：<span style="font-weight: normal"> <?php  echo $mem['invite'];?></span></p>
