    ...
    public function __construct()
    {
        ...
        if (is_weixin())
        {
            if ($this instanceof MobileLoginPage || $this instanceof PluginMobileLoginPage)
            {
                ...
                if($_W['routes'] != 'merch.user' && $_W['routes'] != 'merch.user.index' && $_W['routes'] != 'merch.user.item' && $_W['routes'] != 'merch.user.itemEnd' && $_W['routes'] != 'merch.user.water' && $_W['routes'] != 'merch.user.guidance' && $_W['routes'] != 'merch.user.infos' && $_W['routes'] != 'merch.user.money' && $_W['routes'] != 'merch.user.evaluate' && $_W['routes'] != 'merch.user.loginout' && $_W['routes'] != 'account.binding')
                {
                    if (empty($_W['openid']))
                    {
            ...
            $_W['openid'] = 'wap_user_2_18221403470';
