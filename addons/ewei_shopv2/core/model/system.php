...
class System_EweiShopV2Model
{
    ...
    {
        return array(
            "plugin" => array("title" => "应用", "subtitle" => "应用管理", "icon" => "plugins",
                "items" => array(array("title" => "应用信息"), array("title" => "组件信息", "route" => "coms"), array("title" => "公众号权限", "route" => "perm"), array("title" => "站点小程序",
                    "route" => "wxapp",
                    "route" => "wxapp",
                    "isplugin" => "app")
                , array("title" => "应用中心", "route" => "apps"),
                    array("title" => "应用授权管理", "isplugin" => "grant",
                        "items" => array(array("title" => "幻灯片管理", "route" => "pluginadv"),
                            array("title" => "授权应用管理", "route" => "pluginmanage"), array("title" => "授权套餐管理", "route" => "pluginpackage"),
                            array("title" => "销售记录", "route" => "pluginsale"), array("title" => "系统授权管理", "route" => "plugingrant"),
                            array("title" => "授权管理设置", "route" => "pluginsetting"))))),
            "copyright" => array("title" => "版权", "subtitle" => "版权设置", "icon" => "banquan",
                "items" => array(array("title" => "手机端"), array("title" => "管理端", "route" => "manage"),
                    array("title" => "公告管理", "items" => array(array("title" => "公告管理", "route" => "notice"))))),
            "data" => array("title" => "数据", "subtitle" => "数据管理", "icon" => "statistics", "items" => array(array("title" => "数据清理"),
                array("title" => "数据转移", "route" => "transfer"), array("title" => "计划任务",
                    "items" => array(array("title" => "计划任务", "route" => "task"))),
                array("title" => "工具", "items" => array(array("title" => "七牛存储", "route" => "qiniu", "iscom" => "qiniu"))))),
            "site" => array("title" => "网站", "subtitle" => "网站设置", "icon" => "wangzhan",
                "items" => array(array("title" => "网站", "items" => array(array("title" => "基本设置"),
                    array("title" => "幻灯片", "route" => "banner"), array("title" => "案例分类", "route" => "casecategory"),
                    array("title" => "案例", "route" => "case"), array("title" => "友情链接", "route" => "link"))),
                    array("title" => "文章", "items" => array(array("title" => "文章分类", "route" => "category"),
                        array("title" => "文章管理", "route" => "article"))),
                    array("title" => "内容", "items" => array(array("title" => "内容分类", "route" => "companycategory"),
                        array("title" => "内容管理", "route" => "companyarticle"))),
                    array("title" => "留言板", "items" => array(array("title" => "留言内容", "route" => "guestbook"))),
                    array("title" => "设置", "items" => array(array("title" => "基础设置", "route" => "setting"))))));
    }
